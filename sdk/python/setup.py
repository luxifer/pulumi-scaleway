...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'scaleway', PLUGIN_VERSION, '--server', 'github://api.github.com/luxifer/pulumi-scaleway'])
...
setup(name='luxifer_pulumi_scaleway',
      version=VERSION,
