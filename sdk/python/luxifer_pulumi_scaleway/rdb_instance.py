...
__all__ = ['RdbInstanceArgs', 'RdbInstance']

@pulumi.input_type
class RdbInstanceArgs:
    ...
    def private_network(self) -> Optional[pulumi.Input['RdbInstancePrivateNetworkArgs']]:
        """
    ...
    def private_network(self, value: Optional[pulumi.Input['RdbInstancePrivateNetworkArgs']]):
...
class _RdbInstanceState:
    ...
    def read_replicas(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['RdbInstanceReadReplicaArgs']]]]:
        """
    ...
    def read_replicas(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['RdbInstanceReadReplicaArgs']]]]):
...
class RdbInstance(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
        ...
        main_vpc_public_gateway_pat_rule = scaleway.VpcPublicGatewayPatRule("mainVpcPublicGatewayPatRule",
            ...
            private_port=main_rdb_instance.private_network.port,
            public_port=42,
            protocol="both",
            opts=pulumi.ResourceOptions(depends_on=[
    ...
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param RdbInstanceArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(RdbInstanceArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = RdbInstanceArgs.__new__(RdbInstanceArgs)
        ...
        super(RdbInstance, __self__).__init__(
    ...
    def get(resource_name: str,
            ...
            user_name: Optional[pulumi.Input[str]] = None,
            volume_size_in_gb: Optional[pulumi.Input[int]] = None,
            volume_type: Optional[pulumi.Input[str]] = None) -> 'RdbInstance':
        """
        ...
        __props__ = _RdbInstanceState.__new__(_RdbInstanceState)
        ...
        __props__.__dict__["volume_size_in_gb"] = volume_size_in_gb
        __props__.__dict__["volume_type"] = volume_type
        return RdbInstance(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter(name="privateNetwork")
    def private_network(self) -> pulumi.Output[Optional['outputs.RdbInstancePrivateNetwork']]:
        """
        List of private networks endpoints of the database instance.
        """
        return pulumi.get(self, "private_network")
    ...
    @property
    @pulumi.getter(name="readReplicas")
    def read_replicas(self) -> pulumi.Output[Sequence['outputs.RdbInstanceReadReplica']]:
        """
        List of read replicas of the database instance.
        """
        return pulumi.get(self, "read_replicas")
