...
class GetLbBackendResult:
    ...
    """
    def __init__(__self__, backend_id=None, failover_host=None, forward_port=None, forward_port_algorithm=None, forward_protocol=None, health_check_delay=None, health_check_https=None, health_check_max_retries=None, health_check_port=None, health_check_tcps=None, health_check_timeout=None, id=None, ignore_ssl_server_verify=None, lb_id=None, name=None, on_marked_down_action=None, proxy_protocol=None, send_proxy_v2=None, server_ips=None, ssl_bridging=None, sticky_sessions=None, sticky_sessions_cookie_name=None, timeout_connect=None, timeout_server=None, timeout_tunnel=None):
