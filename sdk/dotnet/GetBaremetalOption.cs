...
namespace luxifer.Scaleway
{
    public static class GetBaremetalOption
    {
        ...
        public static Task<GetBaremetalOptionResult> InvokeAsync(GetBaremetalOptionArgs? args = null, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetBaremetalOptionResult>("scaleway:index/getBaremetalOption:getBaremetalOption", args ?? new GetBaremetalOptionArgs(), options.WithDefaults());
        ...
        public static Output<GetBaremetalOptionResult> Invoke(GetBaremetalOptionInvokeArgs? args = null, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetBaremetalOptionResult>("scaleway:index/getBaremetalOption:getBaremetalOption", args ?? new GetBaremetalOptionInvokeArgs(), options.WithDefaults());
    }
