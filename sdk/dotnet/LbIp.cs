...
namespace luxifer.Scaleway
{
    ...
    public partial class LbIp : global::Pulumi.CustomResource
    {
        /// <summary>
        /// The IP Address
        /// </summary>
        ...
        public LbIp(string name, LbIpArgs? args = null, CustomResourceOptions? options = null)
            : base("scaleway:index/lbIp:LbIp", name, args ?? new LbIpArgs(), MakeResourceOptions(options, ""))
        {
        }

        private LbIp(string name, Input<string> id, LbIpState? state = null, CustomResourceOptions? options = null)
            : base("scaleway:index/lbIp:LbIp", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static LbIp Get(string name, Input<string> id, LbIpState? state = null, CustomResourceOptions? options = null)
        {
            return new LbIp(name, id, state, options);
        }
    }

    public sealed class LbIpArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// `project_id`) The ID of the project the IP is associated with.
        /// </summary>
        ...
        public static new LbIpArgs Empty => new LbIpArgs();
    }

    public sealed class LbIpState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// The IP Address
        /// </summary>
        ...
        public static new LbIpState Empty => new LbIpState();
    }
}
