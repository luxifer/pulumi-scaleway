...
namespace luxifer.Scaleway
{
    public static class GetLbIp
    {
        ...
        public static Task<GetLbIpResult> InvokeAsync(GetLbIpArgs? args = null, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetLbIpResult>("scaleway:index/getLbIp:getLbIp", args ?? new GetLbIpArgs(), options.WithDefaults());
        ...
        public static Output<GetLbIpResult> Invoke(GetLbIpInvokeArgs? args = null, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetLbIpResult>("scaleway:index/getLbIp:getLbIp", args ?? new GetLbIpInvokeArgs(), options.WithDefaults());
    }
