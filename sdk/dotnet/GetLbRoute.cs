...
namespace luxifer.Scaleway
{
    public static class GetLbRoute
    {
        ...
        public static Task<GetLbRouteResult> InvokeAsync(GetLbRouteArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetLbRouteResult>("scaleway:index/getLbRoute:getLbRoute", args ?? new GetLbRouteArgs(), options.WithDefaults());
        ...
        public static Output<GetLbRouteResult> Invoke(GetLbRouteInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetLbRouteResult>("scaleway:index/getLbRoute:getLbRoute", args ?? new GetLbRouteInvokeArgs(), options.WithDefaults());
    }
