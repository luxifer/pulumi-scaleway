...
namespace luxifer.Scaleway
{
    public static class GetWebhostingOffer
    {
        ...
        public static Task<GetWebhostingOfferResult> InvokeAsync(GetWebhostingOfferArgs? args = null, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetWebhostingOfferResult>("scaleway:index/getWebhostingOffer:getWebhostingOffer", args ?? new GetWebhostingOfferArgs(), options.WithDefaults());
        ...
        public static Output<GetWebhostingOfferResult> Invoke(GetWebhostingOfferInvokeArgs? args = null, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetWebhostingOfferResult>("scaleway:index/getWebhostingOffer:getWebhostingOffer", args ?? new GetWebhostingOfferInvokeArgs(), options.WithDefaults());
    }
