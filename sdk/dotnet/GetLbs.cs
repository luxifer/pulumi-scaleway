...
namespace luxifer.Scaleway
{
    public static class GetLbs
    {
        ...
        public static Task<GetLbsResult> InvokeAsync(GetLbsArgs? args = null, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetLbsResult>("scaleway:index/getLbs:getLbs", args ?? new GetLbsArgs(), options.WithDefaults());
        ...
        public static Output<GetLbsResult> Invoke(GetLbsInvokeArgs? args = null, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetLbsResult>("scaleway:index/getLbs:getLbs", args ?? new GetLbsInvokeArgs(), options.WithDefaults());
    }
