...
namespace luxifer.Scaleway
{
    public static class GetLb
    {
        ...
        public static Task<GetLbResult> InvokeAsync(GetLbArgs? args = null, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetLbResult>("scaleway:index/getLb:getLb", args ?? new GetLbArgs(), options.WithDefaults());
        ...
        public static Output<GetLbResult> Invoke(GetLbInvokeArgs? args = null, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetLbResult>("scaleway:index/getLb:getLb", args ?? new GetLbInvokeArgs(), options.WithDefaults());
    }
