...
namespace luxifer.Scaleway
{
    public static class GetIamGroup
    {
        ...
        public static Task<GetIamGroupResult> InvokeAsync(GetIamGroupArgs? args = null, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetIamGroupResult>("scaleway:index/getIamGroup:getIamGroup", args ?? new GetIamGroupArgs(), options.WithDefaults());
        ...
        public static Output<GetIamGroupResult> Invoke(GetIamGroupInvokeArgs? args = null, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetIamGroupResult>("scaleway:index/getIamGroup:getIamGroup", args ?? new GetIamGroupInvokeArgs(), options.WithDefaults());
    }
