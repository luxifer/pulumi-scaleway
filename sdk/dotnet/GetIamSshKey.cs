...
namespace luxifer.Scaleway
{
    public static class GetIamSshKey
    {
        ...
        public static Task<GetIamSshKeyResult> InvokeAsync(GetIamSshKeyArgs? args = null, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetIamSshKeyResult>("scaleway:index/getIamSshKey:getIamSshKey", args ?? new GetIamSshKeyArgs(), options.WithDefaults());
        ...
        public static Output<GetIamSshKeyResult> Invoke(GetIamSshKeyInvokeArgs? args = null, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetIamSshKeyResult>("scaleway:index/getIamSshKey:getIamSshKey", args ?? new GetIamSshKeyInvokeArgs(), options.WithDefaults());
    }
