...
namespace luxifer.Scaleway
{
    public static class GetK8sCluster
    {
        ...
        public static Task<GetK8sClusterResult> InvokeAsync(GetK8sClusterArgs? args = null, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetK8sClusterResult>("scaleway:index/getK8sCluster:getK8sCluster", args ?? new GetK8sClusterArgs(), options.WithDefaults());
        ...
        public static Output<GetK8sClusterResult> Invoke(GetK8sClusterInvokeArgs? args = null, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetK8sClusterResult>("scaleway:index/getK8sCluster:getK8sCluster", args ?? new GetK8sClusterInvokeArgs(), options.WithDefaults());
    }
    ...
    public sealed class GetK8sClusterResult
    {
        ...
        /// </summary>
        public readonly ImmutableArray<Outputs.GetK8sClusterAutoUpgradeResult> AutoUpgrades;
        /// <summary>
        ...
        /// </summary>
        public readonly ImmutableArray<Outputs.GetK8sClusterAutoscalerConfigResult> AutoscalerConfigs;
        ...
        public readonly ImmutableArray<Outputs.GetK8sClusterKubeconfigResult> Kubeconfigs;
        public readonly string? Name;
        public readonly ImmutableArray<Outputs.GetK8sClusterOpenIdConnectConfigResult> OpenIdConnectConfigs;
        /// <summary>
        ...
        private GetK8sClusterResult(
            ...
            ImmutableArray<Outputs.GetK8sClusterAutoUpgradeResult> autoUpgrades,

            ImmutableArray<Outputs.GetK8sClusterAutoscalerConfigResult> autoscalerConfigs,
            ...
            ImmutableArray<Outputs.GetK8sClusterKubeconfigResult> kubeconfigs,

            string? name,

            ImmutableArray<Outputs.GetK8sClusterOpenIdConnectConfigResult> openIdConnectConfigs,
