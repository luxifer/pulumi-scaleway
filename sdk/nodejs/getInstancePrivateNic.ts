 ...
 *
 * const byNicId = pulumi.output(scaleway.getInstancePrivateNic({
 *     privateNicId: "11111111-1111-1111-1111-111111111111",
 *     serverId: "11111111-1111-1111-1111-111111111111",
 * }));
 * const byPnId = pulumi.output(scaleway.getInstancePrivateNic({
 *     privateNetworkId: "11111111-1111-1111-1111-111111111111",
 *     serverId: "11111111-1111-1111-1111-111111111111",
 * }));
 * const byTags = pulumi.output(scaleway.getInstancePrivateNic({
 *     serverId: "11111111-1111-1111-1111-111111111111",
 *     tags: ["mytag"],
 * }));
 * ```
...
export function getInstancePrivateNicOutput(args: GetInstancePrivateNicOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetInstancePrivateNicResult> {
    return pulumi.output(args).apply(a => getInstancePrivateNic(a, opts))
}
