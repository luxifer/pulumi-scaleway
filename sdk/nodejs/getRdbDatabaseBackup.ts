 ...
 *
 * const findByName = pulumi.output(scaleway.getRdbDatabaseBackup({
 *     name: "mybackup",
 * }));
 * const findByNameAndInstance = pulumi.output(scaleway.getRdbDatabaseBackup({
 *     instanceId: "11111111-1111-1111-1111-111111111111",
 *     name: "mybackup",
 * }));
 * const findById = pulumi.output(scaleway.getRdbDatabaseBackup({
...
export function getRdbDatabaseBackupOutput(args?: GetRdbDatabaseBackupOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetRdbDatabaseBackupResult> {
    return pulumi.output(args).apply(a => getRdbDatabaseBackup(a, opts))
}
