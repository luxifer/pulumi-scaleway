 ...
 *
 * const latest = pulumi.output(scaleway.getK8sVersion({
 *     name: "latest",
 * }));
 * ```
 ...
 * import * as scaleway from "@pulumi/scaleway";
 *
 * const byName = pulumi.output(scaleway.getK8sVersion({
 *     name: "1.26.0",
 * }));
 * ```
 */
...
export function getK8sVersionOutput(args: GetK8sVersionOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetK8sVersionResult> {
    return pulumi.output(args).apply(a => getK8sVersion(a, opts))
}
