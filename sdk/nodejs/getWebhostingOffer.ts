 ...
 * const byName = pulumi.output(scaleway.getWebhostingOffer({
 *     name: "performance",
 * }));
 * // Get info by offer id
 * const byId = pulumi.output(scaleway.getWebhostingOffer({
...
export function getWebhostingOfferOutput(args?: GetWebhostingOfferOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetWebhostingOfferResult> {
    return pulumi.output(args).apply(a => getWebhostingOffer(a, opts))
}
