...
export class LbCertificate extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'scaleway:index/lbCertificate:LbCertificate';
     ...
     */
    public readonly customCertificate!: pulumi.Output<outputs.LbCertificateCustomCertificate | undefined>;
    /**
     ...
     */
    public readonly letsencrypt!: pulumi.Output<outputs.LbCertificateLetsencrypt | undefined>;
    /**
...
export interface LbCertificateState {
     ...
     * Configuration block for custom certificate chain. Only one of `letsencrypt` and `customCertificate` should be specified.
     */
    customCertificate?: pulumi.Input<inputs.LbCertificateCustomCertificate>;
    /**
     * The identifier (SHA-1) of the certificate
     */
     ...
     * Configuration block for Let's Encrypt configuration. Only one of `letsencrypt` and `customCertificate` should be specified.
     */
    letsencrypt?: pulumi.Input<inputs.LbCertificateLetsencrypt>;
    /**
     * The name of the certificate backend.
     */
