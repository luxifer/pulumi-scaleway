 ...
 * ```
 */
export class RdbDatabaseBackup extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: RdbDatabaseBackupState, opts?: pulumi.CustomResourceOptions): RdbDatabaseBackup {
        return new RdbDatabaseBackup(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'scaleway:index/rdbDatabaseBackup:RdbDatabaseBackup';

    /**
     * Returns true if the given object is an instance of RdbDatabaseBackup.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is RdbDatabaseBackup {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === RdbDatabaseBackup.__pulumiType;
    }
     ...
     */
    constructor(name: string, args: RdbDatabaseBackupArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: RdbDatabaseBackupArgs | RdbDatabaseBackupState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as RdbDatabaseBackupState | undefined;
            ...
            const args = argsOrState as RdbDatabaseBackupArgs | undefined;
        ...
        super(RdbDatabaseBackup.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface RdbDatabaseBackupState {
    /**
     * Creation date (Format ISO 8601).
     */
 ...
 */
export interface RdbDatabaseBackupArgs {
    /**
     * Name of the database of this backup.
     */
    databaseName: pulumi.Input<string>;
