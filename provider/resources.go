...
import (
	...
	"github.com/luxifer/pulumi-scaleway/provider/pkg/version"
...
func Provider() tfbridge.ProviderInfo {
	...
	prov := tfbridge.ProviderInfo{
		...
		Repository: "https://github.com/luxifer/pulumi-scaleway",
		...
		Resources: map[string]*tfbridge.ResourceInfo{
			...
			"scaleway_instance_ip_reverse_dns": {
				Tok: tfbridge.MakeResource(mainPkg, mainMod, "InstanceIpReverseDns"),
			},
			"scaleway_instance_placement_group": {
				Tok: tfbridge.MakeResource(mainPkg, mainMod, "InstancePlacementGroup"),
			},
			"scaleway_instance_private_nic": {Tok: tfbridge.MakeResource(mainPkg, mainMod, "InstancePrivateNic")},
			"scaleway_instance_security_group": {
				Tok: tfbridge.MakeResource(mainPkg, mainMod, "InstanceSecurityGroup"),
			},
			"scaleway_instance_security_group_rules": {
				Tok: tfbridge.MakeResource(mainPkg, mainMod, "InstanceSecurityGroupRules"),
			},
			...
			"scaleway_object_bucket_lock_configuration": {
				Tok: tfbridge.MakeResource(mainPkg, mainMod, "ObjectBucketLockConfiguration"),
			},
			...
			"scaleway_object_bucket_website_configuration": {
				Tok: tfbridge.MakeResource(mainPkg, mainMod, "ObjectBucketWebsiteConfiguration"),
			},
			...
			"scaleway_vpc_public_gateway_dhcp": {
				Tok: tfbridge.MakeResource(mainPkg, mainMod, "VpcPublicGatewayDhcp"),
			},
			"scaleway_vpc_public_gateway_dhcp_reservation": {
				Tok: tfbridge.MakeResource(mainPkg, mainMod, "VpcPublicGatewayDhcpReservation"),
			},
			...
			"scaleway_vpc_public_gateway_ip_reverse_dns": {
				Tok: tfbridge.MakeResource(mainPkg, mainMod, "VpcPublicGatewayIpReverseDns"),
			},
			"scaleway_vpc_public_gateway_pat_rule": {
				Tok: tfbridge.MakeResource(mainPkg, mainMod, "VpcPublicGatewayPatRule"),
			},
		},
		DataSources: map[string]*tfbridge.DataSourceInfo{
			...
			"scaleway_marketplace_image": {
				Tok: tfbridge.MakeDataSource(mainPkg, mainMod, "getMarketplaceImage"),
			},
			...
			"scaleway_rdb_database_backup": {
				Tok: tfbridge.MakeDataSource(mainPkg, mainMod, "getRdbDatabaseBackup"),
			},
			...
			"scaleway_registry_namespace": {
				Tok: tfbridge.MakeDataSource(mainPkg, mainMod, "getRegistryNamespace"),
			},
			...
			"scaleway_vpc_gateway_network": {
				Tok: tfbridge.MakeDataSource(mainPkg, mainMod, "getVpcGatewayNetwork"),
			},
			"scaleway_vpc_private_network": {
				Tok: tfbridge.MakeDataSource(mainPkg, mainMod, "getVpcPrivateNetwork"),
			},
			"scaleway_vpc_public_gateway": {
				Tok: tfbridge.MakeDataSource(mainPkg, mainMod, "getVpcPublicGateway"),
			},
			"scaleway_vpc_public_gateway_dhcp": {
				Tok: tfbridge.MakeDataSource(mainPkg, mainMod, "getVpcPublicGatewayDhcp"),
			},
			"scaleway_vpc_public_gateway_dhcp_reservation": {
				Tok: tfbridge.MakeDataSource(mainPkg, mainMod, "getVpcPublicGatewayDhcpReservation"),
			},
			"scaleway_vpc_public_gateway_ip": {
				Tok: tfbridge.MakeDataSource(mainPkg, mainMod, "getVpcPublicGatewayIp"),
			},
			"scaleway_vpc_public_gateway_pat_rule": {
				Tok: tfbridge.MakeDataSource(mainPkg, mainMod, "getVpcPublicGatewayPatRule"),
			},
			"scaleway_webhosting_offer": {
				Tok: tfbridge.MakeDataSource(mainPkg, mainMod, "getWebhostingOffer"),
			},
		},
		JavaScript: &tfbridge.JavaScriptInfo{
			PackageName: "@luxifer/pulumi-scaleway",
		...
		Python: &tfbridge.PythonInfo{
			PackageName: "luxifer_pulumi_scaleway",
		...
		Golang: &tfbridge.GolangInfo{
			ImportBasePath: filepath.Join(
				fmt.Sprintf("github.com/luxifer/pulumi-%[1]s/sdk/", mainPkg),
